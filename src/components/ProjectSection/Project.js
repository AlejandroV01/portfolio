        ...
        <div className="project-div project2">
          ...
          <div className="project-information info-left">
            ...
            <div className="project-description desc-left">
              <p>
                This Pokemon API searches through over 800 pokemons to display
                to the user. This projects uses an extensive API which has a
                myriad of information on each pokemon. The user can either
                choose to search for a pokemon of their liking, or generate one
                at random.
              </p>
            </div>
          ...
          <div className="project-information info-left">
            ...
            <div className="project-description desc-left">
              <p>
                ...
                flag, coat of arms, capital, continent, population, languages,
                and currencies will all be grabbed and displayed to users in a
                custom layout.
              </p>
            </div>
            <div className="project-skills">
